/**
 * @module Display Employee Pay Advice Base
 */
sap.ui.define([ "sap/ui/core/mvc/Controller" ], function(Controller) {
	"use strict";

	return Controller.extend("com.costco.au.admin.controller.BaseController", {
		/**
		 * Convenience method for accessing the router.
		 * 
		 * @memberof module:Display Employee Pay Advice Base
		 * 
		 * 
